...
const familyFriendlizer = (text, offensive) => {
  let count = 0;
  offensive.forEach(word => {
    const result = oneWordRemover(text, word);
    text = result[0];
    count += result[1];
  });
  console.log(text);
